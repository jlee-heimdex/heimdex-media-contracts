...
DEFAULT_KEYWORD_DICT: dict[str, list[str]] = {
    ...
    "delivery": ["배송", "택배", "출고", "도착", "무료배송", "당일배송"],
    "coupon": ["쿠폰", "할인코드", "프로모션", "프로모", "적립금"],
    "comparison": ["비교", "차이", "vs", "대비", "비해서"],
    "tutorial": ["사용법", "꿀팁", "팁", "방법", "노하우", "활용법"],
    "qna": ["질문", "답변", "궁금", "문의", "댓글"],
}

PRODUCT_KEYWORD_DICT: dict[str, list[str]] = {
    "skincare": ["스킨케어", "수분크림", "세럼", "토너", "에센스", "로션", "앰플"],
    "makeup": ["메이크업", "파운데이션", "립스틱", "아이섀도우", "블러셔", "쿠션", "컨실러"],
    "mask": ["마스크", "시트마스크", "팩", "패드", "필오프", "워시오프", "클레이마스크"],
    "bodycare": ["바디", "바디로션", "바디워시", "핸드크림", "바디오일", "바디밤", "풋크림"],
    "haircare": ["헤어", "샴푸", "트리트먼트", "컨디셔너", "헤어오일", "헤어에센스", "두피"],
}
